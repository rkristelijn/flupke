...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fpath-key)](https://www.npmjs.com/package/@flupkejs/path-key)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fpath-key)](https://bundlephobia.com/package/@flupkejs/path-key)

Drop-in replacement for path-key

## Install

```bash
npm i @flupkejs/path-key
```

## What this replaces

Drop-in replacement for [`path-key`](https://www.npmjs.com/package/path-key). Zero dependencies, 10 lines of code.
