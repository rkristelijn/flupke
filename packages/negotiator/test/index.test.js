...
describe('negotiator', () => {
  describe('mediaTypes', () => {
    it('should return all media types sorted by quality', () => {
      const n = new Negotiator(mockReq({ accept: 'text/html, application/json;q=0.9' }));
      assert.deepStrictEqual(n.mediaTypes(), ['text/html', 'application/json']);
    });

    it('should filter by available', () => {
      const n = new Negotiator(mockReq({ accept: 'text/html, application/json;q=0.9' }));
      assert.deepStrictEqual(n.mediaTypes(['application/json', 'text/html']), ['text/html', 'application/json']);
    });

    it('should handle wildcard', () => {
      const n = new Negotiator(mockReq({ accept: '*/*' }));
      assert.deepStrictEqual(n.mediaTypes(['text/html', 'application/json']), ['text/html', 'application/json']);
    });

    it('should prefer higher quality', () => {
      const n = new Negotiator(mockReq({ accept: 'text/html;q=0.5, application/json' }));
      assert.strictEqual(n.mediaType(['text/html', 'application/json']), 'application/json');
    });
  });

  describe('languages', () => {
    it('should return all languages sorted by quality', () => {
      const n = new Negotiator(mockReq({ 'accept-language': 'en-US,en;q=0.9,nl;q=0.8' }));
      assert.deepStrictEqual(n.languages(), ['en-US', 'en', 'nl']);
    });

    it('should filter by available', () => {
      const n = new Negotiator(mockReq({ 'accept-language': 'en-US,nl;q=0.8' }));
  ...
  describe('encodings', () => {
    it('should return all encodings', () => {
      const n = new Negotiator(mockReq({ 'accept-encoding': 'gzip, deflate, br' }));
  ...
  describe('charsets', () => {
    it('should return all charsets', () => {
      const n = new Negotiator(mockReq({ 'accept-charset': 'utf-8, iso-8859-1;q=0.5' }));
  ...
  describe('edge cases', () => {
    ...
    it('should handle q=0 (rejected)', () => {
      const n = new Negotiator(mockReq({ accept: 'text/html;q=0, application/json' }));
