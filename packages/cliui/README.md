...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fcliui)](https://www.npmjs.com/package/@flupkejs/cliui)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fcliui)](https://bundlephobia.com/package/@flupkejs/cliui)
...
```bash
npm i @flupkejs/cliui
```

## What this replaces

Drop-in replacement for [`cliui`](https://www.npmjs.com/package/cliui). Zero dependencies, 26 lines of code.
