...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fcamelcase)](https://www.npmjs.com/package/@flupkejs/camelcase)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fcamelcase)](https://bundlephobia.com/package/@flupkejs/camelcase)
...
```bash
npm i @flupkejs/camelcase
```

## What this replaces

Drop-in replacement for [`camelcase`](https://www.npmjs.com/package/camelcase). Zero dependencies, 3 lines of code.
