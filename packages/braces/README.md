...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fbraces)](https://www.npmjs.com/package/@flupkejs/braces)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fbraces)](https://bundlephobia.com/package/@flupkejs/braces)

Drop-in replacement for braces

## Install

```bash
npm i @flupkejs/braces
```

## What this replaces

Drop-in replacement for [`braces`](https://www.npmjs.com/package/braces). Zero dependencies, 142 lines of code.
