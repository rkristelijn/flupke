...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Ftempy)](https://www.npmjs.com/package/@flupkejs/tempy)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Ftempy)](https://bundlephobia.com/package/@flupkejs/tempy)
...
```bash
npm i @flupkejs/tempy
```

## What this replaces

Drop-in replacement for [`tempy`](https://www.npmjs.com/package/tempy). Zero dependencies, 18 lines of code.
