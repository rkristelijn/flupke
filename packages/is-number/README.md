...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fis-number)](https://www.npmjs.com/package/@flupkejs/is-number)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fis-number)](https://bundlephobia.com/package/@flupkejs/is-number)
...
```bash
npm i @flupkejs/is-number
```

## What this replaces

Drop-in replacement for [`is-number`](https://www.npmjs.com/package/is-number). Zero dependencies, 3 lines of code.
