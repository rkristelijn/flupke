...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fcallsites)](https://www.npmjs.com/package/@flupkejs/callsites)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fcallsites)](https://bundlephobia.com/package/@flupkejs/callsites)
...
```bash
npm i @flupkejs/callsites
```

## What this replaces

Drop-in replacement for [`callsites`](https://www.npmjs.com/package/callsites). Zero dependencies, 11 lines of code.
