# @flupkejs/ansi-styles

[![npm](https://img.shields.io/npm/v/@flupkejs%2Fansi-styles)](https://www.npmjs.com/package/@flupkejs/ansi-styles)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fansi-styles)](https://bundlephobia.com/package/@flupkejs/ansi-styles)

ANSI escape code pairs

## Install

```bash
npm i @flupkejs/ansi-styles
```

## What this replaces

Drop-in replacement for [`ansi-styles`](https://www.npmjs.com/package/ansi-styles). Zero dependencies, 46 lines of code.
