...
test('stringify simple', () => { assert.equal(qs.stringify({a:'1',b:'2'}), 'a=1&b=2'); });
test('stringify arrays', () => { assert.equal(qs.stringify({a:['1','2']}), 'a=1&a=2'); });
test('stringify skips null/undefined', () => { assert.equal(qs.stringify({a:null,b:'1'}), 'b=1'); });
