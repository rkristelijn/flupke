...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fforwarded)](https://www.npmjs.com/package/@flupkejs/forwarded)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fforwarded)](https://bundlephobia.com/package/@flupkejs/forwarded)

Drop-in replacement for forwarded

## Install

```bash
npm i @flupkejs/forwarded
```

## What this replaces

Drop-in replacement for [`forwarded`](https://www.npmjs.com/package/forwarded). Zero dependencies, 22 lines of code.
