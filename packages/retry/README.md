...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fretry)](https://www.npmjs.com/package/@flupkejs/retry)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fretry)](https://bundlephobia.com/package/@flupkejs/retry)
...
```bash
npm i @flupkejs/retry
```

## What this replaces

Drop-in replacement for [`retry`](https://www.npmjs.com/package/retry). Zero dependencies, 17 lines of code.
