...
class PathError extends Error {
  constructor(message) { super(message); this.name = 'PathError'; }
}
  ...
  return function(params) {
    ...
    for (const token of data.tokens) {
      if (token.type === 'text') {
        ...
        if (val == null) throw new PathError('Missing parameter: ' + token.name);
...
module.exports = { TokenData, PathError, parse, compile, match, pathToRegexp, stringify };
