...
describe('mime-types', () => {
  describe('lookup()', () => {
    ...
    it('should lookup by path', () => {
      ...
      assert.strictEqual(mime.lookup('/path/to/file.js'), 'application/javascript');
    });
  ...
  describe('contentType()', () => {
    it('should add charset for text types', () => {
      assert.strictEqual(mime.contentType('text/html'), 'text/html; charset=utf-8');
      assert.strictEqual(mime.contentType('text/css'), 'text/css; charset=utf-8');
    });

    it('should add charset for application/javascript', () => {
      assert.strictEqual(mime.contentType('application/javascript'), 'application/javascript; charset=utf-8');
    });

    it('should add charset for application/json', () => {
      assert.strictEqual(mime.contentType('application/json'), 'application/json; charset=utf-8');
    });
