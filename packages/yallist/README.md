...
[![npm](https://img.shields.io/npm/v/@flupkejs%2Fyallist)](https://www.npmjs.com/package/@flupkejs/yallist)
[![bundle](https://img.shields.io/bundlephobia/minzip/@flupkejs%2Fyallist)](https://bundlephobia.com/package/@flupkejs/yallist)
...
```bash
npm i @flupkejs/yallist
```

## What this replaces

Drop-in replacement for [`yallist`](https://www.npmjs.com/package/yallist). Zero dependencies, 71 lines of code.
